...
class FashionDiffusionData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        encode_pos_samples = self.data["encode_pos_samples"][index]
        encode_neg_samples = self.data["encode_neg_samples"][index]
        encode_in_outfits_samples = self.data["encode_in_outfits_samples"][index]
        pos_samples_ids = self.data["pos_samples_ids"][index]
        neg_samples_ids = self.data["neg_samples_ids"][index]
        outfit_ids = self.data["outfit_ids"][index]

        return {"uids": uids, "oids": oids, "outfits": outfits, "input_ids": input_ids, "category": category,
                "encode_pos_samples": encode_pos_samples, "encode_neg_samples": encode_neg_samples, "encode_in_outfits_samples": encode_in_outfits_samples,
                "pos_samples_ids": pos_samples_ids, "neg_samples_ids": neg_samples_ids, "outfit_ids": outfit_ids}
